...
elseif(isset($prodInfo['invDescription'])) {echo $prodInfo['invDescription']; }?></textarea></label>
                        <label><span>Path to Image:</span><input type="text" size="50" name="invImage" <?php if(isset($invImage)){ echo "value='$iinvImage'"; } elseif(isset($prodInfo['invImage'])) {echo "value='$prodInfo[invImage]'"; }?> placeholder="path to image" pattern="[a-zA-Z0-9\.\-\/]{3,50}" title="Only letters, numbers and / please. A minimum of 3 characters." required></label>
